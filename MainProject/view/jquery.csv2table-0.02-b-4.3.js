...
(function($) {
	...
	$.csv2table={
		name     : 'csv2table',
		version  : '2021-03-12', //added function $.csv2table.getRowsArray(id) get the Array of csv
		update   : '2021.03.12', //prev '2014.6.14',
	...
	$.fn.csv2table= function (url,setting){
        ...
        $.csv2table.getRowsArray=getRowsArray
		...
		function mkRowsAry(id,data,sortType,colIndex){
			...
			$.csv2table.setting[id].rowsAry=rowsAry;
        ...
        function getRowsArray(){
            return $.csv2table.setting[id].rowsAry;
        }
